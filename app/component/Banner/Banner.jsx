...
const Banner = () => {
  return (
    <div className="banner-bg relative z-10">
      ...
      <img
        className="absolute -z-10 mt-[90px] hidden md:flex"
        src={bgStar.src}
        alt=""
      />
      ...
      <div className="container pt-[100px] md:pt-[180px]">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between ">
          <div className="relative z-10">
            ...
            />
            <img
              className="absolute -bottom-0 md:-bottom-11 md:-left-10 w-[59px] md:w-[128px]"
              src={bgDot.src}
              alt=""
            />
          </div>
          <div className="md:w-[350px] xl:w-[630px] relative">
            <img
              className="absolute hidden md:flex right-0 bottom-0 cursor-pointer z-10"
              src={mouseScroll.src}
              alt=""
            />
            <h2 className="text-2xl md:text-[38px] text-[#FF4F6E] font-bold mb-[10px] md:mb-[5px]">
              Hello, I'm Sajjad Hossain
            </h2>
            <h1 className="text-4xl lg:text-[65px] md:leading-[54px] lg:leading-[74px] xl:leading-[84px] mb-[43px] md:mb-5 lg:mb-[43px] font-ubuntu">
